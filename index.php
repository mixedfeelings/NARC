...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
      <div class="box bg-coral text-yellow text-stroke col-12 col-md-10 logo">
        <div class="inside">
   ...
   viewBox="0 0 213.12 52.63" style="enable-background:new 0 0 213.12 52.63;" xml:space="preserve">
            ...
            <defs>
              <pattern id="image" x="0" y="0" patternUnits="userSpaceOnUse" height="50" width="50">
                <rect height="200" width="200" fill="#ccff15" style="stroke:none;"/>
                <image height="50" width="50" xlink:href="images/beige-paper.png" style="stroke:1px;"></image>
              </pattern>
            </defs>
            <title>NARC</title>
              <g>
    ...
    <div class="row">
      <div class="box bg-yellow text-coral text-stroke col-12 col-md-5">
        <div class="inside">
        <p>
          Thursday, <span class="no-wrap">November 14,</span> 2019<br/> 
          <span class="small">10:00AM–5:00PM</span>
        </p>
        <p>
          Cards Against Humanity Theater<br/>
          <span class="small">1551 W Homer St, <span class="no-wrap">Chicago, IL 60642</span></span>
         </p>
      </div>
    </div>
    </div>
      ...
      <div class="row">
      <div class="box bg-coral text-paper col-12 col-md-7">
        <div class="inside">
        <p>
          NARC is a day of talks, panels, and workshops dedicated to strengthening the North American Risograph community.
        </p> 
        <p>The event is biennial, held in tandem with <a href="http://cabf.no-coast.org/" class="text-yellow text-stroke">Chicago Art <span class="no-wrap">Book Fair</span></a>. It is organized by <a href="https://issue.press" class="text-yellow text-stroke">Issue Press</a> and <a href="http://perfectly-acceptable.com" class="text-yellow text-stroke">Perfectly Acceptable Press</a>.
        </p>
      </div>
      </div>
    </div>  
      ...
      <div class="row">
      <div class="box bg-paper text-coral col-12 col-md-4">
        <div class="inside">
        <p>
          MORE DETAILS TBA!
        </p> 
